...
export default function PotentialConfigFormModal({
  open,
  mode = "create",
  initialData = null,
  saving = false,
  ...
  useEffect(() => {
    ...
    if (initialData) {
      setForm({
        ...
        rm_weight:
          initialData.rm_weight != null ? String(initialData.rm_weight) : "0.60",
        skip_weight:
          initialData.skip_weight != null ? String(initialData.skip_weight) : "0.40",
        is_active:
        ...
        <div className="mb-6 flex items-start justify-between gap-4">
          <div>
            <h2 className="text-2xl font-semibold tracking-tight text-[#111827]">
              {mode === "edit" ? "Edit Potential Configuration" : "Add Potential Configuration"}
            </h2>
            <p className="mt-1 text-sm text-gray-600">
              Manage RM and skip-level contribution weights for potential scoring.
            </p>
          </div>
